...
def finetune(learning_rate, num_epochs):
    ...
    # 初始化ResNet-18模型
    model = models.resnet18(weights=models.ResNet18_Weights.IMAGENET1K_V1)  # 加载预训练模型
...
for lr in learning_rates:
    for epochs in num_epochs_options:
        ...
        with open("param_search_results_resnet18_finetune.txt", "a") as f:
...
}, os.path.join(save_path, 'ResNet-18_finetune.pth'))
